...
class PostController extends Controller
{
  ...
  public function store(Request $request): RedirectResponse
  {
    ...
    return to_route('posts.index')->with('danger', 'Ha ocurrido un error');
  }
  ...
  //Función de eliminar post, además de eliminar la imagen relacionada
  public function destroy(Post $post)
  {
    ...
    if ($delete) {
      ...
      return redirect()->route('posts.index')->with('infoSuccess', 'Post eliminado');
    }

    return redirect()->route('posts.index')->with('danger', 'Ha ocurrido un error');
  }
